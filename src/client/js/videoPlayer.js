...
const videoScreen = document.querySelector(".videoContainer__screen");
...
const toggleFullscreen = () => {
  ...
  if (fullscreen) {
    ...
    videoContainer.classList = "basicscreen";
  } else {
    videoContainer.requestFullscreen();
    fullscreenBtnIcon.classList = "fas fa-compress";
    videoContainer.classList = "fullscreen";
  }
};
...
videoScreen.addEventListener("click", handlePlayClick);
